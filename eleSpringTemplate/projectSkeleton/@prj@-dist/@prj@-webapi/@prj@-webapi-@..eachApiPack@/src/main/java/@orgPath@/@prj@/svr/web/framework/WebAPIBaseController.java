...
import @orgPath@.@prj@.common.exception.ServiceException;
...
public abstract class WebAPIBaseController {
	...
	public @ResponseBody ResponseEntity<Map<String, Object>> handleServiceException(HttpServletRequest req,
		...
		if (e.getErrorCode().equals("") || e.getErrorCode() == null)
			...
			return new ResponseEntity<Map<String, Object>>(@^prj@BeanUtils.killNull(e.getErrorCode()), e.getMessage(), new HashMap<String, Object>());
	}
	...
	public static class ValidationErrorSimple {
		...
		public ValidationErrorSimple(ObjectError e) {
			...
			this.message = MessageFormat.format(@^prj@BeanUtils.killNull(e.getDefaultMessage()), e.getArguments());
			this.code = e.getCode();
